...
! ###########################   
    ...
    call nc_write_dim(file_ice,"plev", x=[950.d0,850.d0,750.d0,600.d0,500.d0],units="hPa")
    ...
    call nc_write_dim(file_clim,"plev", x=[950.d0,850.d0,750.d0,600.d0,500.d0],units="hPa")
