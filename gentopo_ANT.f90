...
program gentopo
    ...
    call grid_init(gice,name="ANT-20KM",mtype="stereographic",units="kilometers",lon180=.TRUE., &
                   dx=20.d0,nx=90,dy=20.d0,ny=150, &
                   lambda=-40.d0,phi=72.d0,alpha=7.5d0)

    ! ## Define clim grid and output variable field ##
    call grid_init(gclim,name="ANT-50KM",mtype="stereographic",units="kilometers",lon180=.TRUE., &
...
! ###########################   
    ...
    file_ice       = "output/ANT-20KM_ERA-INTERIM_mon_197901-201212.nc"
    file_clim      = "output/ANT-50KM_ERA-INTERIM_mon_197901-201212.nc"
...
! ########################### 
    ...
    ! Define file names for input and output of global grids  
    file_ice       = "output/ANT-20KM_MARv3.2-ERA-INTERIM_197901-201212.nc"
    file_clim      = "output/ANT-50KM_MARv3.2-ERA-INTERIM_197901-201212.nc"
...
! ########################### 
    ...
    ! Define file names for input and output of global grids  
    file_ice       = "output/ANT-20KM_MARv3.2-ERA-INTERIM_197901-201112.nc"
    file_clim      = "output/ANT-50KM_MARv3.2-ERA-INTERIM_197901-201112.nc"
...
! ########################### 
    ...
    ! Define file names for input and output of global grids  
    file_ice       = "output/ANT-20KM_TOPO.nc"
    file_clim      = "output/ANT-50KM_TOPO.nc"
