...
!         call RACMO2rot_to_grid( outfldr, grid, "Antarctica",      clim_range=[2000,2010])
!         call RACMO2rot_to_grid( outfldr, grid, "Antarctica",      clim_range=[2001,2030])
!         call RACMO2rot_to_grid( outfldr, grid, "Antarctica",      clim_range=[2071,2100])
    end if 
